...
public class Bicycle {
    ...
    /**
     * Este constructor inicializa los atributos del objeto con valores por defecto, en el caso de que el usuario
     * no los indique
     */
    public Bicycle() {
        /**
    ...
    /**
     * Este constructor permite inicializar el objeto con los valores que el usuario ingrese en el caso de que
     * así lo haga
     *
     ...
     */
    protected void pedaling(double acceleration) {
        this.speed = this.speed + acceleration;
    }


    /**
     * Este método nos permite disminuir la velocidad de la bicicleta(freno), siempre y cuanto la bicicleta este en
    ...
    /**
     * Este metodo permite restar velocidad a la velocidad actual apartir del metodo brake
     */
