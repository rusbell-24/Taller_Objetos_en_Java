...
public class Fruit {
    ...
    public String color;
    /**
     * En caso de que el objeto fruta tenga más de un color, podemos añadir los demás colores a este ArrayList usando
     * el método set del atributo color.
     */
     ...
     *
     * @return Devuelve el valor actual del atributo color
     */
     ...
     *
     * @return Devuelve el arreglo de colores pertenecientes al objeto en cuestión
     */
