...
public class Person {
    ...
    /**
     * Constructor que nos permite instanciar el objeto con los atributos requeridos
     *
     * @param name       nombre del nuevo objeto person
     * @param lastName1  primer apellido del nuevo objeto person
     * @param lastName2  segundo apellido  del nuevo objeto person
     * @param dateFormat fecha de nacimiento del nuevo objeto person en formato (dd/mm/aaaa)
     * @param height     altura del nuevo objeto person en unidad de cm
     */
     ...
     *
     * @return devuelve la fecha de nacimiento del objeto en cuestión
     */
     ...
     *
     * @return devuelve información sobre el objeto en cuestión
     */
    @Override
